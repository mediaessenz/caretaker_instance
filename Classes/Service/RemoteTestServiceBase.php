 ...
 *
 */
abstract class RemoteTestServiceBase extends \tx_caretaker_TestServiceBase
{
    /**
    ...
    protected function getFailedCommandResultTestResult($commandResult)
    {
        return \tx_caretaker_TestResult::create(
            ($commandResult instanceof CommandResult ? $commandResult->getStatus() : \tx_caretaker_Constants::state_error),
            0,
    ...
    {
        return \tx_caretaker_TestResult::create(
            \tx_caretaker_Constants::state_error,
            0,
