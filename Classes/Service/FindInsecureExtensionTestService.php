...
class FindInsecureExtensionTestService extends RemoteTestServiceBase
{
     ...
     * @var string
     */
    protected $typeDescription = 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:insecure_extension_test_description';
     ...
     * @var string
     */
    protected $configurationInfoTemplate = 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:insecure_extension_test_configuration';
    ...
    public function runTest()
    {
        ...
        if (!$operationResult->isSuccessful()) {
            return \tx_caretaker_TestResult::create(\tx_caretaker_Constants::state_error, 0, 'Remote operation failed: ' . $operationResult->getValue());
        }
        ...
        if (count($errors) == 0 && count($warnings) == 0) {
            return \tx_caretaker_TestResult::create(\tx_caretaker_Constants::state_ok, 0, 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:insecure_extension_test_ok');
        }
        ...
        if ($num_errors > 0) {
            $submessages[] = new \tx_caretaker_ResultMessage('LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:insecure_extension_test_errors');
        ...
        if ($num_warnings > 0) {
            $submessages[] = new \tx_caretaker_ResultMessage('LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:insecure_extension_test_warnings');
    ...
    public function checkExtension($extension, &$errors, &$warnings)
    {
        ...
        if (in_array($ext_key, $ext_blacklist)) {
            if ($ext_installed) {
                $errors[] = [
                    'message' => 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:blacklisted_extension_installed',
                    'values' => $extension,
                ];
            } else {
                $errors[] = [
                    'message' => 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:blacklisted_extension_present',
                    'values' => $extension,
                ];
            }
        ...
        if (is_array($ter_info)) {
            ...
            if ($ext_installed) {
                ...
                $message = 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:insecure_extension_detail_installed';
                switch ($handling) {
                    // Warning
                    case 1:
                ...
                $message = 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:insecure_extension_detail_present';
                switch ($handling) {
                    // Warning
                    case 1:
                        $warnings[] = ['message' => $message, 'values' => $extension];
            ...
            $message = 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:insecure_extension_detail_unknown';
