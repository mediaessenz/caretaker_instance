...
class BackendUserTestService extends RemoteTestServiceBase
{
     ...
     * @var string
     */
    protected $typeDescription = 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:backend_user_test_description';
     ...
     * @var string
     */
    protected $configurationInfoTemplate = 'LLL:EXT:caretaker_instance/Resources/Private/Language/locallang.xml:backend_user_test_configuration';
    ...
    public function runTest()
    {
        ...
        if (count($blacklistedUsernamesFound) > 0) {
            return \tx_caretaker_TestResult::create(\tx_caretaker_Constants::state_error, 0, 'Users [' . implode(',', $blacklistedUsernamesFound) . '] are blacklisted and should not be active.');
        }
